...
#
#     def __init__(self, sign_in=False, sign_out=False):
...
if __name__ == '__main__':
    ...
    # print '\nAttendance'
    # ade_attendance = Attendance()
    # abas_attendance = Attendance(True, False)
    # agus_attendance = Attendance(False, True)
    # joni_attendance = Attendance(True, True)
    #
    # attendance_specification = AttendanceSpecification().and_specification(SignInSpecification()).and_specification(SignOutSpecification())
    #
